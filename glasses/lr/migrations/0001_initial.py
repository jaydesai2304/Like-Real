# Generated by Django 5.0.7 on 2024-07-29 06:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='lr.person')),
            ],
        ),
        migrations.CreateModel(
            name='Address',
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lr.person')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
            fields=[
                ...
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lr.person')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lr.product')),
            ],
        ),
    ]
